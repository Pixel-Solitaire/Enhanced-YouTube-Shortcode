...
if(!class_exists('pxsol_youtube_plugin')) {
	...
	class pxsol_youtube_plugin {
		...
		function pxsol_youtube($atts) {
			...
			$pxsol_youtube_switch = $pxsol_switch_fullScreen.$pxsol_switch_hd.$pxsol_switch_autoplay.$pxsol_switch_controls.$pxsol_switch_autohide.$pxsol_switch_modestbranding.$pxsol_switch_theme;
			//Code generation
		...
		<div id="pxsol_youtube" class="wrap">
			<h2 title="Enhanced YouTube Shortcode for WordPress">Enhanced YouTube Shortcode <i>v1.8</i></h2>
			<div class="pxsol_options pxsol_top"><div class="pxsol_bottom"><div class="pxsol_main">
				...
				<form method="post">
					<ul>
						...
						<div class="clear">&nbsp;</div>
						<li class="dernier"><label for="pxsol_youtube_theme"><strong class="turquoise">Use the <i>dark</i> or <i>light</i> player's theme?</strong><br />
			...
			<div class="pxsol_versions pxsol_top"><div class="pxsol_bottom"><div class="pxsol_main">
				<h3>Changelog</h3>
				<p class="dernier"><strong>v1.8</strong> New "theme" setting / code generation refinement / v2.0 groundwork<br />
