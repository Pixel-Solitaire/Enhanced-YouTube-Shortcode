	...
	class pxsol_youtube_plugin {
		...
		function pxsol_youtube($atts) {
			...
			if ($pxsol_youtube_autoplay == 'true'){
				...
				$pxsol_switch_autoplay = '&autoplay=0';
			};
			$pxsol_switch_hd = '';
			if ($pxsol_youtube_hd == 'true'){
				$pxsol_switch_hd = '&hd=1';
			} else {
				$pxsol_switch_hd = '&hd=0';
			};
			...
			if ($pxsol_youtube_controls == 'true'){
				$pxsol_switch_controls = '&controls=1';
			} else {
			...
			if ($pxsol_youtube_modestbranding == 'true'){
				...
				$pxsol_switch_modestbranding = '&modestbranding=0';
			};
			$pxsol_youtube_switch = $pxsol_switch_fullScreen.$pxsol_switch_hd.$pxsol_switch_autoplay.$pxsol_switch_controls.$pxsol_switch_autohide.$pxsol_switch_modestbranding;
			//Code generation
