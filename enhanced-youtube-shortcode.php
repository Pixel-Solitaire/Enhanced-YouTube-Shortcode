...
function pxsol_youtube($atts) {
	...
	$generated_output = '<object style="height: '.$height.'px; width: '.$width.'px"><param name="movie" value="http://www.youtube.com/v/'.$id.'?version=3'.$pxsolUrlSwitch.'"></param><param name="allowFullScreen" value="'.$allowFullScreen.'"></param><param name="allowScriptAccess" value="always"></param><embed src="http://www.youtube.com/v/'.$id.'?version=3'.$pxsolUrlSwitch.'" type="application/x-shockwave-flash"	allowfullscreen="'.$allowFullScreen.'" allowScriptAccess="always" width="'.$width.'" height="'.$height.'"></embed></object>';
...
function pxsol_youtube_menu() {
	add_options_page( 'WP Enhanced YouTube Shortcode', 'Enhanced YouTube', 'manage_options', __FILE__, 'pxsol_youtube_options' );
}
function pxsol_youtube_options() { ?>
<div id="pxsol_youtube" class="wrap"><h2 title="Enhanced YouTube Shortcode for WordPress">Enhanced YouTube Shortcode <i>v1.5</i></h2><div class="pxsol_options pxsol_top"><div class="pxsol_bottom"><div class="pxsol_main"><h3>Player options</h3>
...
<div class="pxsol_usage pxsol_top"><div class="pxsol_bottom"><div class="pxsol_main"><h3>Usage</h3><p>Simply add this shortcode in your text to display a YouTube player.<br /><i>(...don't forget to replace the ID of the video with your choice!)</i></p><blockquote class="dernier">[youtube_video id="abxjy-emFvs"]</blockquote></div></div></div>
<div class="pxsol_versions pxsol_top"><div class="pxsol_bottom"><div class="pxsol_main"><h3>Changelog</h3><p class="dernier"><strong>v1.5</strong> Initial public release.<br /><strong>v1.4</strong> Bugs repair / visual styles.<br /><strong>v1.3</strong> Possibility to modify the options.<br /><strong>v1.2</strong> Addition of a page to display the usage & settings.<br /><strong>v1.1</strong> Translation of the code in a plugin form.<br /><strong>v1.0</strong> The code is <a target="_blank" href="http://pixel-solitaire.com/2011/08/04/wp-pixel-youtube/" title="Custom YouTube in WordPress – revisited || Les nouvelles du Pixel Solitaire">released</a> as an inclusion in <i>functions.php</i>.</p></div></div></div>
<div class="pxsol_infos pxsol_top"><div class="pxsol_bottom"><div class="pxsol_main"><h3>Additionnal informations</h3><p>Created & tested on a <i>Wordpress 3.2.1</i> installation.</p><p>This is the initial release of the plugin: many other features will be added very soon so keep in touch for updates!!!<br /><br /><strong>Official plugin homapge:</strong><br /><a target="_blank" href="http://pixel-solitaire.com/telechargements/enhanced-youtube-shortcode/" title="Official Plugin Webpage">http://pixel-solitaire.com/telechargements/enhanced-youtube-shortcode/</a>.</p><br /><p class="dernier"><form style="float:left;" action="https://www.paypal.com/cgi-bin/webscr" method="post">
...
function pxsol_youtube_update_options() {
	...
	if ($pxsol_check) { ?>
		<div id="message" class="updated fade"><p>Options saved! <strong>=)</strong></p></div>
	<?php } else { ?>
		<div id="message" class="error fade"><p>Failed to save options <strong>:-(</strong></p></div>
	<?php
	}
}
