...
<div id="pxsol_youtube" class="wrap">
	...
	<strong id="version">Version 2.0</strong>
...
if ($pxsol_check) { ?>
	...
	<div class="pxsol_infos pxsol_top"><div class="pxsol_bottom">
		...
		<p><?php _e('More infos available on the related <a target="_blank" href="http://pxsol.info/p6bxDx" title="Enhanced-YouTube-Shortcode on Wordpress.org">wordpress.org plugins directory pages', 'enhanced-youtube-shortcode');?></a>.</p>
		<br />
		<div class="dernier">
...
if ( file_exists($pxsol_youtube_styles_file) ) { wp_register_style('pxsol-youtube-styles', $pxsol_youtube_styles_link, false, '2.0', 'all'); wp_enqueue_style('pxsol-youtube-styles');};
if ( file_exists($pxsol_youtube_scripts_file) ) { wp_register_script( 'pxsol-youtube-scripts', $pxsol_youtube_scripts_link, array('jquery'), '2.0' ); wp_enqueue_script( 'pxsol-youtube-scripts' );};}
