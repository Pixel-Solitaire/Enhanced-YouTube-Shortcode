...
if ($pxsol_check) { ?>
	<div id="message" class="updated fade">
		<p><?php _e("Settings saved successfully!", 'enhanced-youtube-shortcode');?>&nbsp; &nbsp;<strong>:-)</strong></p>
	</div>
	<?php } else { ?>
	<div id="message" class="error fade">
		<p><?php _e("Houston, we got a problem... Please try to save again.", 'enhanced-youtube-shortcode');?>&nbsp; &nbsp;<strong>:-(</strong></p>
	</div>
